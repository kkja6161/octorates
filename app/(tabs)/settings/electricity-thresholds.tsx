...
export default function ElectricityThresholdsScreen() {
  const router = useRouter();
  const {
    electricityThresholds,
    setElectricityThresholds,
  } = useEnergyRates();
  
  const [tempThresholds, setTempThresholds] = useState<RateThresholds>(electricityThresholds);
  ...
  const handleSave = () => {
    ...
    setElectricityThresholds(tempThresholds);
    setThresholdErrors([]);
    router.back();
  };
